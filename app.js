...
three numbers as separate arguments and 
returns an array where 
the first element is the sum of those three numbers, 
the second element is the product of those three numbers,  and 
the third and fourth elements are strings that EXACTLY follow this example and use the values that were input into the function:
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
  ...
  var message1 = a + ' and ' + b + ' and ' + c + ' sum to ' + outputSum + '.';
  var message2 = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + outputProduct + '.';
  return [outputSum, outputProduct, message1, message2];
}
...
To do addition, use your sum() function that you've already created. You're going to have to be resourceful to figure out how to do this. 
